...
<p align="center">
  <a href="https://github.com/chrisryugj/Docufinder/releases"><img src="https://img.shields.io/badge/version-2.1.0-blue.svg" alt="Version" /></a>
...
- RAM 8GB 이상 (16GB 권장)
- 첫 실행 시 AI 모델 자동 다운로드 (약 420MB, 1회)
- 이후 새 버전이 나오면 앱이 자동으로 알려줍니다

<details>
<summary>설치 시 보안 경고가 뜰 때</summary>

개인 개발 앱이라 Microsoft 인증서가 아직 없어서 경고가 표시될 수 있습니다.

- **"Windows의 PC 보호"** → "추가 정보" → "실행"
- **"스마트 앱 컨트롤이 차단"** (Win 11) → 파일 우클릭 → 속성 → "차단 해제" 체크
- **아무 반응 없을 때** → 백신 실시간 감시 일시 중지 후 재시도
